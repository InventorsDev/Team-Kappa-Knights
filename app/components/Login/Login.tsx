...
import { browserLocalPersistence, setPersistence, browserSessionPersistence } from "firebase/auth"
                        ...
                        <div className="w-full mt-[15px] text-center">
                            ...
                            <form className="w-full mt-[30px]" onSubmit={(e) => handleSignin(e)}>
                                        ...
                                        <span onClick={() => setShowPassword(!showPassword)}
                                            ...
                                            {showPassword ? (
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="h-5 w-5" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10 0-1.326.259-2.59.725-3.75M15 9l6 6M3 3l18 18" />
                                                </svg>
                                            ) : (
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="h-5 w-5" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-.094.312-.202.617-.324.915" />
                                                </svg>
                                            )}
                                        </span>
                                    </div>
                                ...
                                <div className="flex justify-between mb-[30px]">
                                    ...
                                    <button className="hover:cursor-pointer hover:text-[#00BFA5]" onClick={forgotPassword}>Forgot password?</button>
                                </div>
                                <button
